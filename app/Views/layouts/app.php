...
<div class="app-shell app-frame d-flex">
    ...
    <style>
        .bms-sidebar-hidden #btnReopenSidebar {
            display: flex !important;
        }
    </style>
    <button type="button" class="btn btn-primary shadow-sm" id="btnReopenSidebar" onclick="toggleSidebar()" aria-label="Open Sidebar" style="display: none; position: fixed; left: 15px; top: 15px; z-index: 9999; border-radius: 12px; padding: 10px; align-items: center; justify-content: center;">
