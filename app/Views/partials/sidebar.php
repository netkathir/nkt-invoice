...
<aside class="app-sidebar">
    <div class="app-panel app-panel--sidebar">
        <div class="sidebar-top px-3 pt-3 pb-2 d-flex align-items-center justify-content-between gap-2 app-brand">
            <!-- <button type="button" class="btn p-0 border-0 btn-sidebar-toggle" id="btnToggleSidebar" onclick="toggleSidebar()">
                <span class="nav-ico">
        ...
        <div class="sidebar-menu px-2 pb-2">
            <div class="nav flex-column nav-pills">
                <a class="nav-link <?= $isActive('dashboard') ?>" href="<?= base_url('dashboard') ?>"
                    data-bms-title="Dashboard">
                    <span class="nav-ico" aria-hidden="true">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                            <path d="M4 13h7V4H4v9Zm9 7h7V11h-7v9ZM4 20h7v-5H4v5Zm9-7h7V4h-7v9Z" fill="currentColor"
                                opacity=".85" />
                        </svg>
                    </span>
                ...
                <?php if ($hasAccessMenu): ?>
                    <a class="nav-link nav-parent <?= $accessOpen ? 'active' : '' ?>" data-bs-toggle="collapse"
                        href="#navAccess" role="button" aria-expanded="<?= $accessOpen ? 'true' : 'false' ?>"
                        aria-controls="navAccess" data-bms-title="System Admin">
                        <span class="nav-ico" aria-hidden="true">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                <path d="M12 1l8 4v6c0 5-3.4 9.7-8 11-4.6-1.3-8-6-8-11V5l8-4Z" fill="currentColor"
                                    opacity=".25" />
                                <path d="M12 3.3 6 6.3v4.7c0 3.9 2.5 7.7 6 8.9 3.5-1.2 6-5 6-8.9V6.3l-6-3Z"
                        ...
                        <div class="nav flex-column nav-pills nav-sub">
                            <?php if (can('users.view')): ?>
                                <a class="nav-link <?= $isActive('users') ?>" href="<?= base_url('users') ?>"
                                    data-bms-title="Users">
                                    <span class="nav-ico" aria-hidden="true">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                            <path
                                                d="M12 12c2.2 0 4-1.8 4-4s-1.8-4-4-4-4 1.8-4 4 1.8 4 4 4Zm0 2c-3.3 0-8 1.7-8 5v1h16v-1c0-3.3-4.7-5-8-5Z"
                                ...
                                <a class="nav-link <?= $isActive('role_permissions') ?>"
                                    ...
                                    <span class="nav-ico" aria-hidden="true">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                            <path d="M12 1l8 4v6c0 5-3.4 9.7-8 11-4.6-1.3-8-6-8-11V5l8-4Z" fill="currentColor"
                                                opacity=".25" />
                                            <path d="M10.8 13.5 8.6 11.3l-1.4 1.4 3.6 3.6 6.6-6.6-1.4-1.4-5.2 5.2Z"
                                                fill="currentColor" opacity=".85" />
                                        </svg>
                                    </span>
                ...
                <a class="nav-link nav-parent <?= $mastersOpen ? 'active' : '' ?>" data-bs-toggle="collapse"
                    href="#navMasters" role="button" aria-expanded="<?= $mastersOpen ? 'true' : 'false' ?>"
                    aria-controls="navMasters" data-bms-title="Masters">
                    <span class="nav-ico" aria-hidden="true">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                ...
                <a class="nav-link <?= $isActive('billable_items') ?>" href="<?= base_url('billable-items') ?>"
                    data-bms-title="Billable Items">
                    <span class="nav-ico" aria-hidden="true">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                            <path
                                d="M7 3h10v2H7V3Zm12 4H5c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2Zm0 12H5V9h14v10Zm-9-8h4v2h-4v-2Zm0 4h8v2h-8v-2Z"
                                fill="currentColor" opacity=".85" />
                        </svg>
                    </span>
                ...
                <?php if ($canProforma): ?>
                    <a class="nav-link nav-parent <?= $invoicesOpen ? 'active' : '' ?>" data-bs-toggle="collapse"
                        href="#navInvoices" role="button" aria-expanded="<?= $invoicesOpen ? 'true' : 'false' ?>"
                        aria-controls="navInvoices" data-bms-title="Invoices">
                        <span class="nav-ico" aria-hidden="true">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                <path
                                    d="M7 3h10v2H7V3Zm12 4H5c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2Zm0 12H5V9h14v10ZM7 11h10v2H7v-2Zm0 4h7v2H7v-2Z"
                                    fill="currentColor" opacity=".85" />
                            </svg>
                        </span>
                        <span class="nav-txt d-flex align-items-center justify-content-between w-100">
                    ...
                    <div class="collapse <?= $invoicesOpen ? 'show' : '' ?>" id="navInvoices">
                        <div class="nav flex-column nav-pills nav-sub">
                            ...
                            <a class="nav-link <?= $isActive('payments') ?>" href="<?= base_url('payments') ?>"
                                data-bms-title="Payment Capture">
                                <span class="nav-ico" aria-hidden="true">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                        <path d="M12 1l8 4v6c0 5-3.4 9.7-8 11-4.6-1.3-8-6-8-11V5l8-4Z" fill="currentColor"
                                            opacity=".25" />
                            ...
                            <a class="nav-link <?= $isActive('payment_report') ?>" href="<?= base_url('payment-report') ?>"
                                data-bms-title="Received Payments Report">
                                <span class="nav-ico" aria-hidden="true">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                        <path
                                            d="M7 3h10v2H7V3Zm12 4H5c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2Zm0 12H5V9h14v10ZM7 11h10v2H7v-2Zm0 4h7v2H7v-2Z"
                                            fill="currentColor" opacity=".35" />
                                        <path d="M16 11h2v8h-2v-8Zm-3 3h2v5h-2v-5Zm-3-2h2v7h-2v-7Z" fill="currentColor"
                                            opacity=".85" />
                                    </svg>
                                </span>
                ...
                <a class="nav-link <?= $isActive('company_information') ?>"
                    href="<?= base_url('company-information') ?>" data-bms-title="Company Information">
                    <span class="nav-ico" aria-hidden="true">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                            <path d="M4 5h16v14H4V5Zm3 3v8h10V8H7Zm2 2h6v2H9v-2Zm0 4h4v2H9v-2Z" fill="currentColor"
                                opacity=".85" />
                        </svg>
                    </span>
