        ...
        <div class="card-body">
            <form method="post" action="<?= site_url('student/update/' . $student['id']) ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="name" name="name" class="form-control <?= $validation && $validation->hasError('name') ? 'is-invalid' : '' ?>" value="<?= esc(old('name', $student['name'])) ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" id="email" name="email" class="form-control <?= $validation && $validation->hasError('email') ? 'is-invalid' : '' ?>" value="<?= esc(old('email', $student['email'])) ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="roll_no" name="roll_no" class="form-control <?= $validation && $validation->hasError('roll_no') ? 'is-invalid' : '' ?>" value="<?= esc(old('roll_no', $student['roll_no'])) ?>">
